...
import { Tooltip, List, ListItem, ListItemIcon, ListItemText, Menu, MenuItem, IconButton } from '@material-ui/core'
...
const MenuView = ({ baseLink }) => {
    ...
    return (
        <div className={['d-flex', style.iconExpand].join(' ')} style={{ width: '100px' }}>
                        ...
                        return (
                            <React.Fragment key={item.key}>
                                <Link
                                    ...
                                    className={
                                        keyActive === item.key ? 'active' : ' ' + ' text-decoration-none text-dark'
                                    }
                                >
                                    <Tooltip
                                        arrow
                        ...
                        <Link className={'text-decoration-none text-dark'} to="/page/order/ins-import">
                            <div className={style.navbar__item}>
                                <div className={style.active} style={{ color: '#17a2b8' }}>
                                    <div>{<IC_IMPORT />}</div>
                                    <div className={style.navbar_item_text} style={{ color: '#17a2b8' }}>
                                        NHẬP HÀNG
                                    </div>
                                </div>
                            </div>
                        ...
                        <Link className={'text-decoration-none text-dark'} to="/page/order/ins-exportt">
                            <div id="google" className={style.navbar__item}>
                                <div className={style.active} style={{ color: '#ff9800' }}>
                                    ...
                                    <div style={{ color: '#ff9800' }} className={style.navbar_item_text}>
                                        XUẤT HÀNG
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="#google">
                                {windowHeight < 800 && (
                                    <div style={{ background: '#8797a5' }}>
                                        <KeyboardArrowDown style={{ color: '#000' }} fontSize="middle" />
                                    </div>
                                )}
                            </a>
                        </div>
