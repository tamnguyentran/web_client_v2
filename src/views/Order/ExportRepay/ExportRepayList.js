...
const ExportRepayList = () => {
  ...
  useHotkeys("f2", () => history.push("/page/order/ins-exportRepay"), {
  ...
  return (
    <>
      ...
      >
        <Card>
          <CardHeader
            title={t("order.exportRepay.titleCancel", { name: name })}
          />
          <CardContent>
            <Grid container spacing={2}>
              {t("order.exportRepay.invoice_no")}: {name}
            </Grid>
            <Grid container spacing={2}>
              <Grid item xs>
                <FormControl
