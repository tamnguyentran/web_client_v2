...
const InsExportRepay = ({}) => {
    ...
    const handleDelete = () => {
        ...
        sendRequest(serviceInfo.DELETE_PRODUCT_TO_INVOICE, inputParam, handleResultDeleteProduct, true, (e) => {
            handleTimeOut(e)
    ...
    const handleUpdateInvoice = () => {
        ...
        sendRequest(serviceInfo.UPDATE_INVOICE, inputParam, handleResultUpdateInvoice, true, (e) => {
            handleTimeOut(e)
    ...
    return (
        <Grid container spacing={1}>
            ...
            <div className="" style={{ display: 'none' }}>
                <Export_Repay_Bill headerModal={ExportRepay} detailModal={dataSource} componentRef={componentPrint} />
            </div>
