                ...
                action={
                    <>
                        <FormControlLabel
                            ...
                            label={t('only_get_inventory_lot_nocs')}
                        />
                    </>
                }
            />
            <CardContent>
                {isScan ? (
                    <Grid container spacing={1}>
                        <Grid item xs={3}>
                            <Tooltip placement="top" title={t('product.tooltip.barcoded')} arrow>
                                <TextField
                                    fullWidth={true}
                                    autoComplete="off"
                                    margin="dense"
                            ...
                            <Grid item xs={2}>
                                <FormControl margin="dense" variant="outlined" className="w-100">
                                    ...
                                    <Select
                                        ...
                                        name="exp_tp"
                                    >
                                        <MenuItem value="1">{t('order.export.export_type_buy')}vhvhhv</MenuItem>
