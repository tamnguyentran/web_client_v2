...
const tableListAddColumn1 = [
        ...
        { field: 'o_5', title: 'Tên SP',tootip: 'order.export.prod_nm', show: false, disabled: false, minWidth: 100, align: 'center' },
        { field: 'o_6', title: 'order.export.lot_no',tootip: 'order.export.lot_no', show: true, disabled: true, minWidth: 100, align: 'center' },
        { field: 'o_14', title: 'HSD',tootip: 'order.export.exp_dt', show: false, disabled: false, minWidth: 100, align: 'center' },
        { field: 'o_7', title: 'SL xuất',tootip: 'order.export.qty', show: true, disabled: true, minWidth: 100, align: 'center' },
        { field: 'o_9', title: 'ĐV tính',tootip: 'order.export.unit_nm', show: true, disabled: true, minWidth: 200, align: 'center' },
