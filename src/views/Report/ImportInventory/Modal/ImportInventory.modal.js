...
const tableColumn = [
    ...
    { field: 'o_6', title: 'product.name', show: true, disabled: true, minWidth: 100 },
    { field: 'o_7', title: 'order.import.lot_no', show: true, disabled: true, minWidth: 100 },
    {
        field: 'o_8',
    ...
    { field: 'o_11', title: 'order.import.unit_nm', show: true, disabled: true, minWidth: 100 },
    {
        field: 'o_12',
