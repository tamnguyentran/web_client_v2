...
const tableColumn = [
    ...
    { field: 'o_4', title: 'partner.customer.cust_nm_v', show: true, disabled: true, minWidth: 200},
    { field: 'o_6', title: 'report.payment_amount', show: true, disabled: true, minWidth: 100, type: 'currency', align: 'right' },
