      ...
      <Card>
                                ...
                                return (
                                  <Tooltip
                                    ...
                                    title={
                                      ...
                                      >
                                        <Grid item xs={12}>
                                          {t("report.bank_transf_acc_name")} :{" "}
                                          {item.o_10}
                                        </Grid>
                                        <Grid item xs={12}>
                                          {t("report.bank_transf_acc_number")} :{" "}
                                          {item.o_11}
                                        </Grid>
                                        <Grid item xs={12}>
                                          {t("report.bank_transf_name")} :{" "}
                                          {item.o_13}
                                        </Grid>
                                        <Grid item xs={12}>
                                          {t("report.bank_recei_acc_name")} :{" "}
                                          {item.o_14}
                                        </Grid>
                                        <Grid item xs={12}>
                                          {t("report.bank_recei_acc_number")} :{" "}
                                          {item.o_15}
                                        </Grid>
                                        <Grid item xs={12}>
                                          {t("report.bank_recei_name")} :{" "}
                                          {item.o_17}
                                        </Grid>
                                      </Grid>
                                    }
        ...
        <CardActions>
          <div className="d-flex align-items-center">
            ...
            />
            <ExportExcel
              filename="report-payment-import"
              data={dataCSV()}
              headers={headersCSV}
            />
          </div>
